...
class RemotePage(Model):
    ...
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepage/'
...
class RemotePageWithManyFields(Model):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithmanyfields/'
...
class RemotePageWithBooleanFields(Model):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithbooleanfields/'
...
class RemotePageWithCustomSlug(Model):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithcustomslug/'
...
class RemotePageWithRelationsThrough(Model):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithrelationsthrough/'
...
class RemotePageWithRelations(Model):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithrelations/'
...
class RemotePageWithNamedRelations(Model):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithnamedrelations/'
...
class RemotePageWithProxy(RemotePage):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithproxy/'
...
class RemotePageWithCustomPrimaryKey(Model):
    ...
    @staticmethod
    def get_resource_url_list():
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithcustomprimarykey/'
...
class RemotePageWithCustomPrimaryKeyCountOverridden(RemotePageWithCustomPrimaryKey):
    ...
    def get_resource_url_count(self):
        return u'http://127.0.0.1:8000/django_roa_server/remotepagewithcustomprimarykey/count2/'
